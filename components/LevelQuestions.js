...
export default function LevelQuestions({ navigation, route }) {
  ...
  const handleSubmit = () => {
    if (
      quesNo >=
      route.params["levelInformation"][route.params["currentLevel"] - 1]["mcq"]
        .length -
        1
    ) {
      navigation.navigate({
      ...
      <View style={styles.container}>
        <View style={styles.inRow}>
          ...
          <View style={styles.styleTitle}>
            <Text style={styles.styleHeading}>
