...
const Greetings = ({ navigation, route }) => {
    ...
    <ScrollView>
      <View>
        ...
        <View style={{ alignItems: "center", marginTop: hp("2%") }}>
          {route.params["currentLevel"] == "1" && (
            <NeuButton
              style={{ marginTop: hp("10%"), marginBottom: 30 }}
              color="#eef2f9"
              width={wp("65%")}
              height={hp("8%")}
              borderRadius={30}
